                            ...
                            <div class="col-sm-6">
                                <div class="mb-5 ">
                                    <div class="text-sm-right">
                                        <h4 class="mb-2 mt-md-2">Maintence, Repairs, Operations</h4>
                            ...
                            <div class="mb-2 ml-auto"> <span class="text-muted">Document Details:</span>
                                <div class="d-flex flex-wrap wmin-md-400">
                                    <ul class="list list-unstyled mb-0 text-left">
                                        <li>Profit Center:</li>
                                        <li>Sub-profit Center:</li>
                                        <li>Cost Center:</li>
                                    </ul>
                                    <ul class="list list-unstyled text-right mb-0 ml-auto">
                                        <li><span class="font-weight-semibold">{{ $data->pallet_no }}</span></li>
                                        <li>{{ $data->profit_center }}</li>
                                        <li>{{ $data->sub_profit_center }}</li>
                                        <li>{{ $data->cost_center }}</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
